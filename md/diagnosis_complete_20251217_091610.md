...
📊 전체 Studies: 3,866건
  ...
  ❌ description_raw 결측 Study: 672건 (17.4%)
  ❌ time_frame_raw 결측 Study: 109건 (2.8%)

✅ 유효 데이터 Study 수:
  ✓ measure_raw 유효: 3,866건 (100.0%)
  ✓ description_raw 유효: 3,194건 (82.6%)
  ✓ time_frame_raw 유효: 3,757건 (97.2%)
...
📊 총 timeFrame 데이터: 25,255건

📈 패턴 분류 결과:
  • Baseline 포함 (change_from_baseline): 9,469건 (37.5%)
  • 기간 패턴 (At Day/Week/Month N): 263건 (1.0%)
...
🎯 파싱 가능성 요약:
  ✅ 파싱 가능 (기간 패턴 + Baseline 포함): 24,261건 (96.1%)
...
📝 패턴별 예시 (최대 3개):
  ...
  기간 패턴 (At Day/Week/Month N):
    ...
    - At Weeks 4, 8, 12, 16, 20, 24, 36, 52, 76, 104, 128, 156, 180, 208, 232 (End of ...
    - At week 24
...
📋 전체 Study 수: 3,866건
  • Primary outcome 있는 Study: 3,866건
  • Secondary outcome 있는 Study: 2,905건

✅ 약어 추출 성공률 (해당 outcome이 있는 Study 기준):
  📌 PRIMARY: 965건 / 3,866건 (25.0%)
     → PRIMARY outcome이 있는 3,866건 중 965건에서 약어 추출 성공
  📌 SECONDARY: 1,182건 / 2,905건 (40.7%)
     → SECONDARY outcome이 있는 2,905건 중 1,182건에서 약어 추출 성공

🎯 상세 분류 (전체 3,866건 Study 기준):
  ✅ 둘 다 성공: 506건 (13.1%)
  ...
  → 검증: 506 + 459 + 676 + 2,225 = 3,866건
  → 검증: PRIMARY 성공 = 506 + 459 = 965건 ✓
  → 검증: SECONDARY 성공 = 506 + 676 = 1,182건 ✓
...
📋 전체 Study 수: 3,866건
  • PRIMARY outcome 있는 Study: 3,866건
  • SECONDARY outcome 있는 Study: 2,905건
  • PRIMARY outcome의 measure 약어 추출 성공: 965건
  • SECONDARY outcome의 measure 약어 추출 성공: 1,182건

✅ PRIMARY Outcome (measure 약어 추출 성공한 965건 기준):
  ✅ outcome + frame 둘 다 성공: 821건 (85.1%)
  📌 outcome만 성공 (frame 실패): 144건 (14.9%)
  📌 frame만 성공 (measure 실패, PRIMARY outcome 있음): 2,257건
  → 검증 (measure 성공 기준): 965건 = 965건
  → 검증 (PRIMARY outcome 전체 기준): 3,222건 ≤ 3,866건

✅ SECONDARY Outcome (measure 약어 추출 성공한 1,182건 기준):
  ✅ outcome + frame 둘 다 성공: 1,035건 (87.6%)
  📌 outcome만 성공 (frame 실패): 147건 (12.4%)
  📌 frame만 성공 (measure 실패, SECONDARY outcome 있음): 1,358건
  → 검증 (measure 성공 기준): 1,182건 = 1,182건
  → 검증 (SECONDARY outcome 전체 기준): 2,540건 ≤ 2,905건
...
INDUSTRY             1274         8915         2,353건(26.4%) 2,534건(28.4%) 80.3       
